-- translation_source: a translation of the game into Spanish.
--
-- Every table under lang/ is a catalog keyed by the English source; an
-- empty value means "not translated yet" and keeps rendering in English.
-- 0.5.0 additionally translates the Pokédex categories (lang/dex_kinds.lua)
-- and ships a Spanish naming screen with accented letters (lang/naming.lua).
--
...
return function(mod)
  ...
  mod.events:on("game.ready", function()
    ...
    mod.log:info("Spanish: %d strings translated", total)
  end)

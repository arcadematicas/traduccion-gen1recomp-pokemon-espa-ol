# translation-es-goldilvercrystal

Traducción al español para **Pokémon Oro, Plata y Cristal** en gen1recomp.
...
Extrae el contenido de este mod (es la raíz plana) en:
...
- [gen1recomp](https://github.com/bryanthaboi/gen1recomp) — motor y modkit.

## Licencia

GPL-3.0 (las traducciones provienen de PokeCorpus, GPL-3.0). Consulta el
